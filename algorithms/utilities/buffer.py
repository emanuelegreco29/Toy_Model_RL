...
from .utilities import get_shape_from_space


class Buffer(ABC):
    """
    Abstract base class for a buffer that stores experience data.
    This class defines the interface for inserting data, updating the buffer after training,
...
class ReplayBuffer(Buffer):
    ...
    def __init__(self, args, num_agents, obs_space, act_space):
        ...
        self.use_proper_time_limits = True #args.use_proper_time_limits
        self.use_gae = True #args.use_gae
        self.gae_lambda = 0.95 #args.gae_lambda
        # rnn config
